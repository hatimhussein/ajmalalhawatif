...
class MerchantActiveNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new WelcomeRegisterMail($notifiable, $body, "Activated Successfully"))->to($address);
    }
    ...
    public function generateBodyTest($notifiable)
    {
        ...
        $replacements = [
            ...
            '{account_number}' => $notifiable->account_number,
        ];
    ...
    {
        return NotificationBody::where('key', 'merchant_register')->first();
    }
}
