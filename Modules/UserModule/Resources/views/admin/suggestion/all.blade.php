...
<div class="tab-pane fade  {{$complete=='all'?'show active':''}}" id="justify-pills-all" role="tabpanel" aria-labelledby="justify-pills-messages-tab">
