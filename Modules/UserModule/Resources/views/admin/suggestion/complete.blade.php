...
<div class="tab-pane fade  {{$complete=='complete'?'show active':''}}" id="justify-pills-complete" role="tabpanel" aria-labelledby="justify-pills-messages-tab">
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>{{__('usermodule::admin.complete')}} </h4>
                        </div>
                    </div>
                ...
                <div class="widget-content widget-content-area">
                    <div class=" mb-4">
                        <table id="ecommerce-product-list1" class="table table-hover  table-bordered text-center">
                            ...
                            <tbody>
                            @foreach($contacts->where('complete',1) as $contact)
                                <tr>
                                    <td>{{$contact->id}}</td>
                                    <td>
