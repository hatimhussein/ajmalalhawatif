...
@section('title')
    {{__('usermodule::admin.add_new_user')}}
@endsection
                ...
                <div class="page-title">
                    ...
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li class="active"><a href="#">{{__('usermodule::admin.add_new_user')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>{{__('usermodule::admin.add_new_user')}}</h4>
                                </div>
                            </div>
                        </div>

                        <div class="widget-content widget-content-area">
                            <form action="{{url('admin/users')}}" method="POST" class="needs-validation" novalidate>
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="first_name" value="{{ old('first_name') }}" class="form-control"
                                               ...
                                               placeholder="{{__('usermodule::login.first_name')}}" required>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        <label for="phone">{{__('adminmodule::admin.phone')}}</label>
                                        <input type="text" name="phone" value="{{old('phone')}}"
                                               class="form-control" id="phone" minlength="9" maxlength="14"
