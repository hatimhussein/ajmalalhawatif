                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-12 col-12 ">
                                        <div class="profile-info-section mb-4">
                                            <div class="card" style="">
                                                <div class="card-body">
                                                    <h5 class="mb-4"><i
                                                            class="flaticon-user-plus"></i> {{$user->first_name .' '. $user->last_name}}
                                                    </h5>
                                                    <p class="mb-2"><span class="usr-work-position">{{__('usermodule::admin.phone')}} : </span>
                                                        <a href="">{{$user->phone}}</a></p>
                                                    <p class="mb-2"><span class="usr-work-position">{{__('usermodule::admin.email')}} : </span>
                                                        <a href="">{{$user->email}}</a></p>

                                                    <p class="mb-2"><span class="usr-work-position">{{__('usermodule::admin.address')}} : </span>
                                                        <a href="">
                                    ...
                                    <div class="col-xl-9 col-lg-12 col-12 ">
                                        <div class="widget-content justify-pill rounded-pills-icon" style="padding:0px">
                                            ...
                                            <ul class="nav nav-pills mt-3  justify-content-center navs nav3"
                                                id="justify-pills-tab" role="tablist">

                                                <li class="nav-item ml-2 mr-2">
                                                    <a class="nav-link mb-2 text-center active"
                                                       id="justify-pills-Suggestion-tab" data-toggle="pill"
                                                       href="#justify-pills-Suggestion" role="tab"
                                                       aria-controls="justify-pills-Suggestion"
                                                       aria-selected="true">{{__('usermodule::admin.orders')}}</a>
                                                </li>
                                            ...
                                            <div class="tab-content" id="justify-pills-tabContent">
                                                <div class="tab-pane fade show active" id="justify-pills-Suggestion"
                                                     role="tabpanel" aria-labelledby="justify-pills-Suggestion-tab">
                                                            ...
                                                            <div class="widget-content">
                                                                <div class=" mb-4">
                                                                    <table id="ecommerce-product-list"
                                                                        ...
                                                                        <tr>
                                                                            <th>#</th>
                                                                            <th>{{__('usermodule::admin.total')}}</th>
                                                ...
                                                <div class="tab-pane fade " id="justify-pills-complaint" role="tabpanel"
                                                     aria-labelledby="justify-pills-complaint-tab">
                                                    <div class="row margin-bottom-120">
                                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                            <div class="statbox widget box box-shadow">
                                                                <div class="widget-content">
                                                                    <div class="table-responsive mb-4">
                                                                        <table id="ecommerce-product-list1"
                                                                               class="table table-hover   table-bordered text-center">
                                                                            <thead>
                                                                            <tr>
                                                                                <th>#</th>
