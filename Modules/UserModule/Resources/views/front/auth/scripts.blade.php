...
<script type="text/javascript">
    ...
    function is_loading(button) {
        let old = button.html();
        button.html('{{__('usermodule::login.loading')}}');
                ...
                'statusCode': {
                    200: function (response){
                        ...
                        if (response.code == 201) {
                            ...
                            toastr["success"](
                                "{{ __('usermodule::login.login_success') }}");
    ...
    $("#update_account_informations").submit(function (event) {
        ...
        if (isValidForm) {
            ...
            $.ajax({
                'type': 'post',
                'url': '{{ url('update-account-information') }}',
                data: formdata,
                processData: false,
                contentType: false,
                'statusCode': {
    ...
    $("#update_merchant_informations").submit(function (event) {
        ...
        if (isValidForm) {
            ...
            $.ajax({
                'type': 'post',
                'url': '{{ url('update-merchant-information')}}',
                data: formdata,
                processData: false,
                contentType: false,
                'statusCode': {
    ...
    $("#update_change_form").submit(function (event) {
        ...
        if (isValidForm) {
            ...
            $.ajax({
                'type': 'post',
                'url': '{{ url('update-change-password')}}',
                data: formdata,
                processData: false,
                contentType: false,
                'statusCode': {
            ...
            $.ajax({
                ...
                'statusCode': {
                    200: function (response) {
                        ...
                        $('#country_id').val('');
                        $('#government_id').html(
                            '<option disabled selected value="">{{ __('usermodule::login.choose_zone') }}</opiton>');
                        ...
                        toastr["success"]("{{ __('commonmodule::validation.updated') }}")
    ...
    $("#update_address_form").submit(function (event) {
        ...
        $.ajax({
            'type': 'post',
            'url': '{{ url('update-account-address')}}',
            data: formdata,
            processData: false,
            contentType: false,
            'statusCode': {
