            ...
            <div class="row">
                ...
                <section class="col-main col-md-9 col-sm-8 wow bounceInUp">
                    <div class="my-account">
                        ...
                        <form id="update_account_informations" class="form">
                            <div class="fieldset">
                                    ...
                                    <li class="fields">
                                        <div class="customer-name row">
                                            <div class="field name-firstname col-md-6">
                                                <label for="firstname"
                                                       class="required">{{__('usermodule::login.first_name')}}<em>*</em></label>
                                                <div class="input-box">
                                            ...
                                            <div class="field name-lastname col-md-6">
                                                <label for="lastname"
                                                       class="required">{{__('usermodule::login.last_name')}}<em>*</em></label>
                                                <div class="input-box">
                                                    <input type="text" name="last_name"
                                                           value="{{$user->last_name}}" title="Last Name"
                                                           maxlength="255"
                                                           class="input-text required-entry">
                                                </div>
                                            </div>
                                            ...
                                            <div class="field name-lastname col-md-4">
                                                ...
                                                <div class="input-box">
                                                    <input type="text" name="phone"
                                                           value="{{$user->phone}}" title="Phone" minlength="9" maxlength="14"
                                                           class="input-text required-entry">
                                                </div>
                                            </div>
                                        </div>
