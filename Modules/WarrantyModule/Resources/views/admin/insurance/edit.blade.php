...
@section('title')
    {{__('warrantymodule::insurance.update_insurance')}}
@endsection
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                        <h4>{{__('warrantymodule::insurance.update_insurance')}}</h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-8 col-12">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <h2 class="legend">{{__('warrantymodule::insurance.insurance_info')}}
                                ...
                                <div class="col-xl-4 col-lg-4 col-12">
                                    <form action="{{route('insurance.update', $insurance->id)}}"
