                ...
                <section class="col-md-12">
                    <div class="my-account">
                        ...
                        <form id="warranty-form"
                              action="{{route('front.warranty.store', ['type' => $type ?? 'card'])}}" class="form"
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-6">
                                                @if($inputs->contains('key', 'warranty_number'))
                                                    <div class="form-group">
                                                        @include("warrantymodule::front.includes.input", ['localeFile' => $localeFile, 'input' => $inputs->where('key', 'warranty_number')->first()])
                                                    </div>
                                                @endif
                                                ...
                                                @if($inputs->contains('key', 'user_name'))
                                                    <div class="form-group">
                                                        @include("warrantymodule::front.includes.input", ['localeFile' => $localeFile, 'input' => $inputs->where('key', 'user_name')->first(), 'disabled' => true])
                                                    </div>
                                                @endif
                                                @if($inputs->contains('key', 'phone'))
                                                    <div class="form-group">
                                                        @include("warrantymodule::front.includes.input", ['localeFile' => $localeFile, 'input' => $inputs->where('key', 'phone')->first()])
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="col-md-6 purple">
                                                ...
                                                {{--                                                    <div class="form-group">--}}
                                                {{--                                                        @include("warrantymodule::front.includes.input", ['localeFile' => $localeFile, 'input' => $inputs->where('key', 'sent_at')->first(), 'disabled' => true])--}}
                                                {{--                                                    </div>--}}
                                                {{--                                                @endif--}}
                                                @if($inputs->contains('key', 'usage_date'))
                                                    <div class="form-group">
                                                        @include("warrantymodule::front.includes.input", ['localeFile' => $localeFile, 'input' => $inputs->where('key', 'usage_date')->first(), 'read_only' => $type == 'sms'])
                                                    </div>
                                                @endif
                                                @if($inputs->contains('key', 'dummy_text_1'))
                                                    <div class="form-group">
                                                        @include("warrantymodule::front.includes.input", ['localeFile' => $localeFile, 'input' => $inputs->where('key', 'dummy_text_1')->first()])
                                                    </div>
                                                @endif
                                                @if($inputs->contains('key', 'dummy_text_2'))
                                                    <div class="form-group">
                                                        @include("warrantymodule::front.includes.input", ['localeFile' => $localeFile, 'input' => $inputs->where('key', 'dummy_text_2')->first()])
                                                    </div>
                                                @endif
                                                @if($inputs->contains('key', 'dummy_text_3'))
                                                    <div class="form-group">
                                                        @include("warrantymodule::front.includes.input", ['localeFile' => $localeFile, 'input' => $inputs->where('key', 'dummy_text_3')->first()])
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                ...
                'statusCode': {
                    200: function (response) {
                        if (response.code === 201) {
                            ...
                            setTimeout(function () {
                                window.location = "{{route('front.warranty.index')}}";
                            }, 3000);
                        }
                    },
