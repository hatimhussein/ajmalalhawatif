...
use Modules\WarrantyModule\Notifications\WarrantyReplyNotification;
...
class WarrantyAdminController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('warrantymodule::admin.warranty.index', compact('warranties', 'localeFile'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('warrantymodule::admin.warranty.edit', compact('warranty', 'localeFile'));
    }
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        return redirect()->route('warranty.index', ['type' => $warranty->type])->with('updated', 'updated');
    }
