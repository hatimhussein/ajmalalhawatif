                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="font-size:13px; font-family:sans-serif; color:#676767"
                                            align="right"><span style="color:#707070">{{__('ordermodule::admin.date')}}: </span><span
                                                style="color:#000000;display:inline-block">{{$order->created_at}}</span></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="font-size:13px; font-family:sans-serif; color:#676767" align="left">
                                            <span style="color:#707070">{{__('ordermodule::admin.shipping_time')}}: </span><a
                                                style="outline:none; color:#f15a23; text-decoration:none;"
                                                href="#">{{$order->delivery_time}}</a></td>
                                        <td style="font-size:13px; font-family:sans-serif; color:#676767"
                                            align="right"><span style="color:#707070">{{__('ordermodule::admin.payment_type')}}: </span><span
                                                style="color:#000000;display:inline-block">{{__('ordermodule::payment.'.$order->payment_type)}}</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="tablepadding"
                                                            ...
                                                            <table width="100%" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td><span style="color:#909090"> {{$order->user->first_name . ' ' . $order->user->last_name}} </span></td>
                                                                    </tr>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <span style="color:#909090">{{__('ordermodule::admin.shipping_address')}}</span><br>
                                                            ...
                                                            <table width="100%" align="left" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            style="font-size:13.5px; font-family:sans-serif; line-height:1.5;color:#000000;text-align:center">
                                                                            <span style="color:#909090">{{__('ordermodule::admin.mobile')}} </span><br>
                                                                                {{$order->user->phone}}</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                        ...
                        <td class="tablepadding"
                            ...
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                <tbody>
                                    <tr>
                                        <td
                                            style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767" align="right">
                                            <span style="color:#707070">{{__('ordermodule::admin.order_id')}}: </span><a
                                                style="outline:none; color:#f15a23; text-decoration:none;"
                                                href="#">{{$order->id}}</a></td>
                                        <td style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767"
                                            align="left"><span style="color:#707070">{{__('ordermodule::admin.date')}}: </span><span
                                                style="color:#000000;display:inline-block">{{$order->created_at}}</span></td>
                                    </tr>
                                    <tr>
                                        <td
