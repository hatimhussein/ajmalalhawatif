...
@section('title')
    {!! __('fronthomemodule::home.all_products') !!}
...
@section('content')
    ...
    @include('fronthomemodule::content.breadCrumbs',['pages'=>[__('fronthomemodule::home.all_products')]])
                                            ...
                                            <dd id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                                ...
                                                <ol class="m-filter-css-checkboxes ">
                                                    @foreach($categories as $category)
                                                        <li>
                                                            <span title="Black">
                                                                <input class="category_id checkbox-filter"
                                                ...
                                                <dd id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                                    ...
                                                    <ol class="m-filter-css-checkboxes ">
                                                        @foreach($brands as $brand)
                                                            <li>
                                                                <span title="Black">
                                                                    <input class="brands checkbox-filter"
                                                                           name="brands[]"
                                                                           type="checkbox" value="{{$brand->id}}"/>
                                                                    {!! LanguageHelper::nameTranslate($brand) !!}
                                                                </span>
                                                            </li>
                                                        @endforeach
                                                    </ol>
