...
@section('title')
    {!! LanguageHelper::nameTranslate($category) !!}
@endsection
...
@section('content')
    ...
    @include('fronthomemodule::content.breadCrumbs',['pages'=>[LanguageHelper::nameTranslate($category)]])
                                    ...
                                    <div class="block-content">
                                                ...
                                                <dd id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                                    ...
                                                    <ol class="m-filter-css-checkboxes ">
                                                        @foreach($category->child as $child)
                                                            <li>
                                                                <span title="Black"><input
                                                                        class="category_id checkbox-filter"
                                                                        name="category_ids[]" type="checkbox"
                                                                        value="{{$child->id}}"/> {!! LanguageHelper::nameTranslate($child) !!}  </span>
                                        ...
                                        @if($cat_brands->count() > 0)
                                            <dl class="narrow-by-list">
                                                <dt class=" m-collapseable" data-toggle="collapse"
                                                    ...
                                                    {{__('productmodule::product.filter_by_brand')}}
                                                    <i class="icon-chevron-right arrow"></i>
                                                </dt>
                                                <dd id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                                    data-parent="#accordionExample">
                                                    ...
                                                    <ol class="m-filter-css-checkboxes ">
                                                        @foreach($cat_brands as $brand)
                                                            <li>
                                                                <span title="Black"><input
                                                                        class="brands checkbox-filter" name="brands[]"
                                                                        type="checkbox" value="{{$brand->id}}"/>  {!! LanguageHelper::nameTranslate($brand) !!} </span>
                                                ...
                                                <dd id="collapse{{$key}}" class="collapse"
                                                    ...
                                                    <ol class="m-filter-css-checkboxes ">
                                                        @foreach($option->optionValues as $options_values)
                                                            <li>
                                                                <span title="Black"><input
                                                                        class="options_values checkbox-filter"
                                                                        name="options_values[]" type="checkbox"
                                        ...
                                        <dl class="narrow-by-list">
                                            ...
                                            <dd id="collapseSix" class="collapse" aria-labelledby="headingSix"
                                                ...
                                                <!-- <li>
                                                      <span  title="Black"><input class="price checkbox-filter" name="price"  type="radio" value="0,1000" /> 0 {!! LanguageHelper::nameTranslate(Cookie::get('currency')) !!} - 10000 {!! LanguageHelper::nameTranslate(Cookie::get('currency')) !!}</span>

                                                  </li>
                                                  <li>
                                                      <span  title="Black"><input class="price checkbox-filter" name="price"  type="radio" value="10000,20000" /> 10000 {!! LanguageHelper::nameTranslate(Cookie::get('currency')) !!} - 20000 {!! LanguageHelper::nameTranslate(Cookie::get('currency')) !!}</span>
                        ...
                        <div class="category-products">
                            <div class="toolbar">
                                ...
                                <div id="sort-by">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#">{{__('productmodule::product.choose')}}
    ...
    @else
        <h1 style="margin:60px 0" class="text-center">{{__('productmodule::product.no_products')}}</h1>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function getData(page, sort_type, sort_by) {
            ...
            let options_values = $('.options_values:checkbox:checked').map(function () {
                return this.value;
            }).get();

            let category_ids = $('.category_id:checkbox:checked').map(function () {
                return this.value;
            }).get();

            let brands = $('.brands:checkbox:checked').map(function () {
                return this.value;
            }).get();
