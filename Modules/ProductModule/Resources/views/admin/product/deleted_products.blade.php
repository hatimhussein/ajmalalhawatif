...
@section('title')
    {{__('productmodule::admin.deleted_products')}}
@endsection
        ...
        <div class="container">
            <div class="page-header">
                <div class="page-title">
                    <h3>{{__('productmodule::admin.deleted_products')}}</h3>
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            <li><a href="{{url('/admin')}}"><i class="flaticon-home-fill"></i></a></li>
                            <li class="active"><a href="#">{{__('productmodule::admin.deleted_products')}}</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>{{__('productmodule::admin.deleted_products')}} </h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                            ...
                                            <td class="align-center">
                                                <ul class="table-controls">
                                                    @can('delete_product')
                                                        ...
                                                        <li>
                                                            <form class="inline"
                                                                  action="{{url('admin/restore-product/' . $product->id)}}"
                                                                  method="POST">
                                                                {{ method_field('PUT') }}
                                                                {!! csrf_field() !!}
                                                                <button class="unst" title="Restore" type="submit"
