...
@section('title')
      {{__('ordermodule::admin.add_new_status')}}
@endsection
      ...
      <div class="container">
          <div class="page-header">
              <div class="page-title">
                  <h3>{{__('ordermodule::admin.add_new_status')}}</h3>
              </div>
          </div>

          <div class="row">
            <form  action="{{url('admin/status')}}" class="col-lg-12" method="POST"  data-role="validator" data-on-before-submit="no_submit" data-on-error-input="notifyOnErrorInput" data-show-error-hint="false" novalidate="novalidate" enctype="multipart/form-data">
              @csrf
                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                    <h4>{{__('ordermodule::admin.add_new_status')}}</h4>
                                </div>
                        ...
                        <div class="widget-content widget-content-area">
                                  ...
                                  <div class="col-md-4 ">
                                      <div  class="statbox widget box box-shadow">
                                        ...
                                        <div class="widget-content">
                                            <select name="status_type_id"  placeholder="" class="disabled-results form-control custom-select" >
                              ...
                              <div class="input-control required col-md-4 mb-4 ">
                                          <input name="title" value="{{ old('title') }}" class="form-control" data-validate-func="required" data-validate-arg="6"  data-validate-hint="{{__('configmodule::admin.please')}} {{__('ordermodule::admin.status')}}" placeholder="{{__('ordermodule::admin.status')}}" autocomplete="off">
                                          @if ($errors->has('title'))
