...
<div id="content" class="main-content">
  ...
  @if($key->id == 6)
<a href="{{url('admin/orders/merchant/report_done')}}"class="btn" style="background-color: #f8538d; color: #fff">{{$key->title}}</a>
  @elseif($key->id == 7)
 <a href="{{url('admin/orders/merchant/report_cancel')}}" class="btn" style="background-color: #1a73e9; color: #fff">{{$key->title}}</a>
  @else
 <a href="{{url('admin/orders/merchant/report/'.$key->id.'')}}" class="btn" style="background-color: #5247bd; color: #fff">{{$key->title}}</a>
  @endif
  @endforeach
                                   <!--  <a href="{{url('admin/orders/merchant/report/1')}}" class="btn" style="background-color: #00b1f4; color: #fff">{{__('adminmodule::admin.new')}}</a>
                                    <a href="{{url('admin/orders/merchant/report/2')}}" class="btn" style="background-color: #5247bd; color: #fff">{{__('adminmodule::admin.preparing')}}</a>
                                    <a href="{{url('admin/orders/merchant/report/3')}}" class="btn" style="background-color: #8828e1; color: #fff">{{__('adminmodule::admin.prepared')}}</a>
                                    <a href="{{url('admin/orders/merchant/report/4')}}" class="btn" style="background-color: #f8538d; color: #fff">{{__('adminmodule::admin.charging')}}</a>
                                    <a href="{{url('admin/orders/merchant/report/5')}}" class="btn" style="background-color: #1a73e9; color: #fff">{{__('adminmodule::admin.charged')}}</a>
                                      <a href="{{url('admin/orders/merchants/report_done')}}" class="btn" style="background-color: #1a73e9; color: #fff">{{__('adminmodule::admin.done')}}</a>
                                        <a href="{{url('admin/orders/merchants/report_cancel')}}" class="btn" style="background-color: #1a73e9; color: #fff">{{__('adminmodule::admin.canceled')}}</a>
    -->
                                    ...
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       ...
                                       <form action="{{url('admin/orders/merchant/report/search/'.$status_id)}}" method="POST" class="ws-validate">
                                            @csrf
                                              <div class="row">
                                ...
                                <tbody>
                                  @foreach($orders as $order)
                                    <tr>
                                          ...
                                          <td>{{($order->user)?$order->user['authorized_person']:''}} </td>
