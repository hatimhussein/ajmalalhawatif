...
@section('content')
    ...
    <!-- Breadcrumbs -->
    @include('merchantmodule::content.breadCrumbs',['pages'=>[__('fronthomemodule::contactus.contact_us')]])
            ...
            <div class="row">
                ...
                <section class="col-main col-sm-4 wow bounceInUp animated">
                    <div class="details">
                        ...
                        <div class="contact-phone"><span>{!! LanguageHelper::configTranslate($site_data->where('key','hotline')->first())  !!}<br>
