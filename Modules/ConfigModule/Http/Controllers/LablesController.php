...
class LablesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('configmodule::admin.labels.index', compact('front_lang_ar', 'front_lang_en', 'front_file_ar', 'front_file_en', 'warranty_file_ar', 'warranty_file_en', 'warranty_lang_ar', 'warranty_lang_en', 'insurance_file_ar', 'insurance_file_en', 'insurance_lang_ar', 'insurance_lang_en'));
    }
