...
@section('content')
    <div id="content" class="main-content">
        <div class="container">
            ...
            <div class="row">
                <form  action="{{url('admin/slider/'.$slider->id)}}" style="width:100%"  method="POST"  data-role="validator" data-on-before-submit="no_submit" data-on-error-input="notifyOnErrorInput" data-show-error-hint="false" novalidate="novalidate" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="row">
                                ...
                                <div class="widget-content widget-content-area">
                                    <div class="row">
                                        ...
                                        <div class="input-control required col-md-12 mb-4 required">
                                            <input name="link" value="{{ $slider->link }}" class="form-control" data-validate-arg="6"  data-validate-hint="{{__('configmodule::admin.rlink')}} " placeholder="{{__('configmodule::admin.link')}}" autocomplete="off">
                                            @if ($errors->has('link'))
                    ...
                    <div class="row">
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <div class="custom-file-container__image-preview product-list-img">
                                        <img  src="{{asset('images/slider/'.$slider->image_ar)}}" />
                                    </div>
                                    <div class="custom-file-container" data-upload-id="myFirstImage">
                                        <label>{{__('configmodule::admin.image_ar')}} <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image"></a></label>
                                        <label class="custom-file-container__custom-file" >
                                            <input id="photo"  name="image_ar" type="file" class="custom-file-container__custom-file__custom-file-input"   accept="image/*">
                                            <span class="custom-file-container__custom-file__custom-file-control"></span>
                                        </label>
                                        <h3>
                                            @if ($errors->has('image_ar'))
                                                @include('commonmodule::includes.error',['errors'=>$errors->toArray(),'filed'=>'image_ar'])
                                            @endif
                                        </h3>
                        ...
                        <div class="col-lg-6 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <div class="custom-file-container__image-preview product-list-img">
                                        <img  src="{{asset('images/slider/'.$slider->image_en)}}" />
                                    </div>
                                    <div class="custom-file-container" data-upload-id="mySecondImage">
                                        <label>{{__('configmodule::admin.image_en')}} <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image"></a></label>
                                        <label class="custom-file-container__custom-file" >
                                            <input id="photo2"  name="image_en" type="file" class="custom-file-container__custom-file__custom-file-input"   accept="image/*">
                                            <span class="custom-file-container__custom-file__custom-file-control"></span>
                                        </label>
                                        <h3>
                                            @if ($errors->has('image_en'))
                                                @include('commonmodule::includes.error',['errors'=>$errors->toArray(),'filed'=>'image_en'])
                                            @endif
                                        </h3>
                                        <div class="custom-file-container__image-preview"></div>
                                    </div>
