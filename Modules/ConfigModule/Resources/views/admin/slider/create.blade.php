...
@section('content')
    <div id="content" class="main-content">
        <div class="container">
            ...
            <div class="row">
                <form  action="{{url('admin/slider')}}" style="width:100%"  method="POST"  data-role="validator" data-on-before-submit="no_submit" data-on-error-input="notifyOnErrorInput" data-show-error-hint="false" novalidate="novalidate" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                ...
                                <div class="widget-content widget-content-area">
                                    <div class="row">
                                        ...
                                        <div class="input-control required col-md-12 mb-4 required">
                                            <input name="link" value="" class="form-control" data-validate-arg="6"  data-validate-hint="{{__('configmodule::admin.rlink')}} " placeholder="{{__('configmodule::admin.link')}}" autocomplete="off">
                                            @if ($errors->has('link'))
