...
@section('title')
    {{__('configmodule::admin.update_news')}}
@endsection
...
@section('content')
    <div id="content" class="main-content">
        <div class="container">
            ...
            <div class="row">
                <form action="{{ route('news.update', $news->id) }}" class="col-12" method="POST"
                      data-role="validator" data-on-before-submit="no_submit" data-on-error-input="notifyOnErrorInput"
                      data-show-error-hint="false" novalidate="novalidate" novalidate>
                    @csrf
                    {{ method_field('PUT') }}
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                        <h4>{{__('configmodule::admin.update_news')}}</h4>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-9 mb-4 input-control required">
                                                                <textarea name="desc_ar" class="form-control"
                                                                          ...
                                                                          rows="5"
                                                                          placeholder="{{__('configmodule::admin.news_ar')}}">{{ $news->desc_ar }}</textarea>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-9 mb-4 input-control required">
                                                                <textarea name="desc_en" class="form-control" rows="5"
                                                                          placeholder="{{__('configmodule::admin.news_en')}}"
                                                                          data-validate-func="required"
                                                                          data-validate-arg="5"
                                                                          data-validate-hint="{{__('productmodule::category.rdesc_en')}}">{{ $news->desc_en }}</textarea>
                                                    ...
                                                    <div class="widget-content" style="user-select: none">
                                                        <label for="viewed_levels-1">
                                                            <input data-validate-func="required" data-validate-arg="6"
                                                                   ...
                                                                   type="checkbox"
                                                                   value="1"
                                                                {{ in_array(1, $news->viewed_levels) ? 'checked' : ''}}>
                                                        ...
                                                        <label for="viewed_levels-2">
                                                            <input data-validate-func="required" data-validate-arg="6"
                                                                   ...
                                                                   type="checkbox"
                                                                   value="2"
                                                                {{ in_array(2, $news->viewed_levels) ? 'checked' : ''}}>
                                                        ...
                                                        <label for="viewed_levels-3">
                                                            <input data-validate-func="required" data-validate-arg="6"
                                                                   ...
                                                                   type="checkbox"
                                                                   value="3"
                                                                {{ in_array(3, $news->viewed_levels) ? 'checked' : ''}}>
                                                        ...
                                                        <label for="viewed_levels-4">
                                                            <input data-validate-func="required" data-validate-arg="6"
                                                                   ...
                                                                   type="checkbox"
                                                                   value="4"
                                                                {{ in_array(4, $news->viewed_levels) ? 'checked' : ''}}>
                                                        ...
                                                        <label for="viewed_levels-5">
                                                            <input data-validate-func="required" data-validate-arg="6"
                                                                   ...
                                                                   type="checkbox"
                                                                   value="5"
                                                                {{ in_array(5, $news->viewed_levels) ? 'checked' : ''}}>
                                                ...
                                                <div class="statbox widget box box-shadow">
                                                    ...
                                                    <div class="widget-content">
                                                        <label class="switch s-success  mb-4 mr-2">
                                                            ...
                                                            <input name="status"
                                                                   type="checkbox" {{ ( $news->status==1 ) ? 'checked' : '' }}>
