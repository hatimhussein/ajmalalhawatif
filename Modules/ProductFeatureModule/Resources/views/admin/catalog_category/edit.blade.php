...
@section('content')
    <div id="content" class="main-content">
        <div class="container">
            ...
            <div class="row">
                <form action="{{url('admin/catalog_category/'.$category->id)}}" class="col-12" method="POST"
                                                        ...
                                                        <div class="widget-content">
                                                            <select name="parent_id"
                                                                ...
                                                                @foreach($categories as $categorys)
                                                                    <option
                                                                        {{($categorys->id == $category->parent_id)?"selected":""}} value="{{$categorys->id}}">{{$categorys->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
