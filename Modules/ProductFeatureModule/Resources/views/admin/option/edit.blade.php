...
@section('title')
{{__('productfeaturemodule::admin.update_option')}}
@endsection
...
<div id="content" class="main-content">
    <div class="container">
        ...
        <div class="row">
            <form action="{{url('admin/option/'.$option->id)}}" style="width:100%" method="POST" data-role="validator"
                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                    <h4>{{__('productfeaturemodule::admin.update_option')}}</h4>
                                </div>
                        ...
                        <div class="widget-content widget-content-area">
                            <div class="row">
                                <div class="col-xl-9 col-lg-9 col-9 ">
                                    <div class="form-row">
                                        <div class="input-control required col-md-9 mb-4 required">
                                            <input name="name_ar" value="{{ $option->name_ar }}" class="form-control"
                                    ...
                                    <div class="form-row">
                                        <div class="input-control required col-md-9 mb-4 ">
                                            <input name="name_en" value="{{ $option->name_en }}" class="form-control"
                                                data-validate-func="required" data-validate-arg="6"
                                ...
                                <div class="mb-4 ">
                                    <div class="statbox widget box box-shadow col-9">
                                        ...
                                        <div class="widget-content  ">
                                            <select name="type" placeholder=""
                                                ...
                                                <option {{($option->type=="list")?'selected':''}} value="list">{{__('productfeaturemodule::admin.list')}}</option>
                                                <option {{($option->type=="color")?'selected':''}} value="color">{{__('productfeaturemodule::admin.color')}}
                                                </option>
                                            </select>
                                        </div>
