                    ...
                    <h3>
                      ...
                      <div class="crumbs">
                          <ul id="breadcrumbs" class="breadcrumb">
                              <li><a href="{{url('admin/option')}}"><i class="flaticon-home-fill"></i>{{__('productfeaturemodule::admin.options')}}</a></li>
                              <li><a href="#">{!! LanguageHelper::nameTranslate($option) !!}</a></li>
                          </ul>
                      </div>
                  </div>
                          ...
                          <div class="widget-header">
                              <div class="row">
                                  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                      <h4>{!! LanguageHelper::nameTranslate($option) !!}</h4>
                                  </div>
                              </div>
                          </div>
                                              ...
                                              <td>
                                                <ul class="table-controls">
                                                  ...
                                                  <!-- <li><a  href="{{url('admin/option/'.$option->id)}}" data-toggle="tooltip" data-placement="top" title="Show"><i class="flaticon-view  bg-info p-1 text-white br-6 mb-1"></i></a></li> -->
                                                    ...
                                                    <li><a  href="{{url('admin/option-value/'.$value->id.'/edit')}}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="flaticon-edit  bg-success p-1 text-white br-6 mb-1"></i></a></li>
                                                    <li>
                                                      <form class="inline" action="{{url('admin/option-value/' . $value->id)}}" method="POST">
                                                        {{ method_field('DELETE') }} {!! csrf_field() !!}
                                                        <button class="unst" title="Delete" type="submit" onclick="return confirm('تأكيد الحذف !!')" type="button"
