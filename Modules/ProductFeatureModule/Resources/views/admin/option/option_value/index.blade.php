          ...
          <div class="container">
              <div class="page-header">
                  <div class="page-title">
                      <h3>{{__('productfeaturemodule::option.options')}}</h3>
                      <div class="crumbs">
                          <ul id="breadcrumbs" class="breadcrumb">
                              <li><a href="index.html"><i class="flaticon-home-fill"></i></a></li>
                              <li><a href="#">{{__('productfeaturemodule::option.options')}}</a></li>
                          </ul>
                      </div>
                  </div>

                  <div class="page-title" style="float:right">
                      <a href="{{url('admin/option/create')}}" class="mt-4 btn btn-button-4"> {{__('productfeaturemodule::option.addNew')}}  </a>
                  </div>
                          ...
                          <div class="widget-header">
                              <div class="row">
                                  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                      <h4>{{__('productfeaturemodule::option.options')}}</h4>
                                  </div>
                              </div>
                          </div>
                                  ...
                                  <table id="zero-config" class="table table-striped table-hover table-bordered" style="width:100%">
                                      <thead>
                                          <tr class="text-center">
                                              <th>#</th>
                                              <th>{{__('productfeaturemodule::option.name_ar')}}</th>
                                              <th>{{__('productfeaturemodule::option.name_en')}}</th>
                                              <th >{{__('productfeaturemodule::option.operations')}}</th>
                                          </tr>
                                      </thead>
                                      <tbody>
                                              ...
                                              <td>
                                                <ul class="table-controls">
                                                  ...
                                                  <!-- <li><a  href="{{url('admin/option/'.$option->id)}}" data-toggle="tooltip" data-placement="top" title="Show"><i class="flaticon-view  bg-info p-1 text-white br-6 mb-1"></i></a></li> -->
                                                    ...
                                                    <li>
                                                      <form class="inline" action="{{url('admin/option-value/' . $option->id)}}" method="POST">
                                                        {{ method_field('DELETE') }} {!! csrf_field() !!}
                                                        <button class="unst" title="Delete" type="submit" onclick="return confirm('سيتم حذف هذة الفئة والفئات التى تحتها !')" type="button"
