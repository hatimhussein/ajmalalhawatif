...
@section('title')
{{__('productfeaturemodule::admin.update_option_value')}}
@endsection
...
<div id="content" class="main-content">
    <div class="container">
        ...
        <div class="row">
            <form action="{{url('admin/option-value/'.$value->id)}}" style="width:100%" method="POST"
                ...
                @csrf
                {{ method_field('PUT') }}
                <input type="hidden" value="{($value->option->type}}" id="type" name="type">
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                    <h4>{{__('productfeaturemodule::admin.update_option_value')}}</h4>
                                </div>
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="row">
                                <div class="col-xl-9 col-lg-9 col-9">
                                    ...
                                    <div class="form-row ">
                                        <div class="input-control required col-md-9 mb-4 required">
                                            ...
                                            <select name="option_id" id="option" placeholder=""
                                                ...
                                                <option {{($option->id==$value->option_id)?'selected':''}}
                                    ...
                                    <div class="form-row">
                                        <div class="input-control required col-md-9 mb-4 required">
                                            <input name="name_ar" value="{{$value->name_ar}}" class="form-control"
                                                data-validate-func="required" data-validate-arg="6"
                                    ...
                                    <div class="form-row">
                                        <div class="input-control required col-md-9 mb-4 ">
                                            <input name="name_en" value="{{$value->name_en}}" class="form-control"
                                                data-validate-func="required" data-validate-arg="6"
                                    ...
                                    <div id="color" class="form-row"
                                        style="display:{{($value->option->type=='color')?'':'none'}}">
                                        <div class="input-control required col-md-9 mb-4 ">
                                            <input type="text" name="color" value="{{$value->value}}" id="wheel-demo"
                                                class="form-control demo" data-control="wheel">
