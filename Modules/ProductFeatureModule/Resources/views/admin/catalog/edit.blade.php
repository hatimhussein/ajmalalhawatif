...
@section('title')
    {{__('productfeaturemodule::admin.update_catalog')}}
@endsection
...
@section('content')
    <div id="content" class="main-content">
        <div class="container">
            ...
            <div class="row">
                <form action="{{ route('catalog.update', $catalog->id) }}" class="col-lg-12" method="POST"
                      data-role="validator"
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                        <h4>{{__('productfeaturemodule::admin.update_catalog')}}</h4>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="tab-pane fade show active" id="arabic" role="tabpanel"
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="input-control required col-md-12 mb-4 required">
                                                                <input name="name_ar"
                                                                       value="{{ old('name_ar') ?? $catalog->name_ar }}"
                                                                       class="form-control"
                                                            ...
                                                            <textarea name="desc_ar" class="form-control" rows="5"
                                                                      ...
                                                                      placeholder="{{__('productmodule::category.desc_ar')}}">{{ old('desc_ar') ?? $catalog->desc_ar }}</textarea>
                                                    ...
                                                    <div class="tab-pane fade" id="english" role="tabpanel"
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <textarea name="desc_en" class="form-control" rows="5"
                                                                      ...
                                                                      placeholder="{{__('productmodule::category.desc_en')}}">{{ old('desc_en') ?? $catalog->desc_en }}</textarea>
                                                    ...
                                                    <div class="widget-content">
                                                        <select name="brand_id" required
                                                            ...
                                                            @foreach($brands as $brand)
                                                                <option
                                                                    {{($brand->id == $catalog->brand_id)?"selected":""}} value="{{$brand->id}}">{{ $brand->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="statbox widget box box-shadow   ">
                                                    ...
                                                    <select name="catalog_category_id"
                                                        ...
                                                        @foreach($categories as $key)
                                                            <option
                                                                {{($key->id == $catalog->catalog_category_id)?"selected":""}}
                                            ...
                                            <div class="widget-content" style="user-select: none">
                                                <label for="viewed_levels-1">
                                                    <input data-validate-func="required" data-validate-arg="6"
                                                           ...
                                                           type="checkbox"
                                                           value="1"
                                                        {{ in_array(1, $catalog->viewed_levels) ? 'checked' : ''}}>
                                                ...
                                                <label for="viewed_levels-2">
                                                    <input data-validate-func="required" data-validate-arg="6"
                                                           ...
                                                           type="checkbox"
                                                           value="2"
                                                        {{ in_array(2, $catalog->viewed_levels) ? 'checked' : ''}}>
                                                    {{__('productfeaturemodule::admin.second_level')}}
                                                </label>
                                                <label for="viewed_levels-3">
                                                    <input data-validate-func="required" data-validate-arg="6"
                                                           ...
                                                           type="checkbox"
                                                           value="3"
                                                        {{ in_array(3, $catalog->viewed_levels) ? 'checked' : ''}}>
                                                    {{__('productfeaturemodule::admin.third_level')}}
                                                </label>
                                                <label for="viewed_levels-4">
                                                    <input data-validate-func="required" data-validate-arg="6"
                                                           ...
                                                           type="checkbox"
                                                           value="4"
                                                        {{ in_array(4, $catalog->viewed_levels) ? 'checked' : ''}}>
                                                    {{__('productfeaturemodule::admin.fourth_level')}}
                                                </label>
                                                <label for="viewed_levels-5">
                                                    <input data-validate-func="required" data-validate-arg="6"
                                                           ...
                                                           type="checkbox"
                                                           value="5"
                                                        {{ in_array(5, $catalog->viewed_levels) ? 'checked' : ''}}>
                                                    {{__('productfeaturemodule::admin.fifth_level')}}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
