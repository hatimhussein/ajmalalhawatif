...
@section('title')
    {{__('productfeaturemodule::admin.update_deliverytime')}}
@endsection
...
@section('content')
    <div id="content" class="main-content">
        <div class="container">
            ...
            <form action="{{url('admin/delivery_time/'.$delivery_time->id)}}" style="width:100%" method="POST"
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                        <h4>{{__('productfeaturemodule::admin.update_deliverytime')}}</h4>
                                    </div>
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input name="deliverytime_ar" value="{{ $delivery_time->deliverytime_ar }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="deliverytime_en" value="{{ $delivery_time->deliverytime_en }}"
                                               class="form-control" data-validate-func="required"
                                               data-validate-arg="6"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-3 col-sm-4 col-4">
                                        <div class="statbox widget box box-shadow ">
                                            ...
                                            <input name="sort_order" value="{{ $delivery_time->sort_order }}"
                                                   class="form-control" data-validate-func="required"
                                                   data-validate-arg="6"
                                                   type="number">
                                        ...
                                        <div class="statbox widget box box-shadow">
                                            ...
                                            <label class="switch s-success  mb-4 mr-2">
                                                ...
                                                <input name="for_user" value="1"
                                                       type="checkbox" {{($delivery_time->for_user)?'checked':''}}>
                                        ...
                                        <div class="statbox widget box box-shadow">
                                            ...
                                            <label class="switch s-success  mb-4 mr-2">
                                                ...
                                                <input name="for_merchant" value="1"
                                                       type="checkbox" {{($delivery_time->for_merchant)?'checked':''}}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
