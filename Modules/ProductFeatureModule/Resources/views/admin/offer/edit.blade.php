...
@section('title')
    {{__('productfeaturemodule::admin.update_offer')}}
@endsection
...
@section('content')
    <div id="content" class="main-content">
        <div class="container">
            ...
            <div class="row">
                <form action="{{url('admin/offers/'.$offer->id)}}" style="width:100%" method="POST"
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                        <h4>{{__('productfeaturemodule::admin.update_offer')}}</h4>
                                    </div>
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-12">
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="input-control  col-md-12 mb-4 ">
                                                                        ...
                                                                        <textarea name="desc_ar"
                                                                                  ...
                                                                                  autocomplete="off">{{$offer->desc_ar}}</textarea>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="input-control  col-md-12 mb-4 ">
                                                                        <textarea name="desc_en"
                                                                                  ...
                                                                                  autocomplete="off">{{$offer->desc_en}}</textarea>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="widget-content ">
                                                                        ...
                                                                        <select name="offer_products[]"
                                                                            ...
                                                                            @foreach($products as $product)
                                                                                ...
                                                                                <option
                                                                                    {{($offer->products->contains($product->id))?'selected':''}} value="{{$product['id']}}">{{$product->name}}</option>
                                        ...
                                        <div class="">
                                            <label class="" for="viewed_levels">
                                                @php($viewed_levels = explode(',',$offer->viewed_levels))
                                                <label class=""
                                                ...
                                                <label for="viewed_levels-1">
                                                    <input data-validate-func="required" data-validate-arg="6"
                                                           id="viewed_levels-1" name="viewed_levels[]" type="checkbox"
                                                           value="1" {{ in_array(1,$viewed_levels)?'checked':''}}>
                                                    {{__('productfeaturemodule::admin.first_level')}}
                                                </label>
                                                <label for="viewed_levels-2">
                                                    <input data-validate-func="required" data-validate-arg="6"
                                                           id="viewed_levels-2" name="viewed_levels[]" type="checkbox"
                                                           value="2" {{ in_array(2,$viewed_levels)?'checked':''}}> {{__('productfeaturemodule::admin.second_level')}}
                                                </label>
                                                <label for="viewed_levels-3">
                                                    <input data-validate-func="required" data-validate-arg="6"
                                                           id="viewed_levels-3" name="viewed_levels[]" type="checkbox"
                                                           value="3" {{ in_array(3,$viewed_levels)?'checked':''}}> {{__('productfeaturemodule::admin.third_level')}}
                                                </label>
                                                <label for="viewed_levels-4">
                                                    <input data-validate-func="required" data-validate-arg="6"
                                                           id="viewed_levels-4" name="viewed_levels[]" type="checkbox"
                                                           value="4" {{ in_array(4,$viewed_levels)?'checked':''}}> {{__('productfeaturemodule::admin.fourth_level')}}
                                                </label>
                                                <label for="viewed_levels-5">
                                                    <input data-validate-func="required" data-validate-arg="6"
                                                           id="viewed_levels-5" name="viewed_levels[]" type="checkbox"
                                                           value="5" {{ in_array(5,$viewed_levels)?'checked':''}}> {{__('productfeaturemodule::admin.fifth_level')}}
                                                </label>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="statbox widget box box-shadow">
                                            ...
                                            <div class="input-control required col-md-12 mb-3   required">
                                                <input value="{{$offer->start_date}}" type="date" name="start_date"
                                            ...
                                            <div class="input-control required col-md-12 mb-3   required">
                                                <input type="date" value="{{$offer->end_date}}" name="end_date"
                                                       class="form-control" autocomplete="off">
                                            </div>
                                        ...
                                        <div class="input-control select full-size mb-3 col-md-12 required"
                                            ...
                                            <select id="type" name="type" class="form-control text-center">
                                                <option
                                                    {{($offer->type =='value')?'selected':''}} value="value">{{__('productfeaturemodule::admin.amount')}}</option>
                                                <option
                                                    {{($offer->type =='percentage')?'selected':''}} value="percentage">{{__('productfeaturemodule::admin.precentage')}}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="statbox widget box box-shadow text-center">
                                            <div class="mt-3" id="type_val">
                                                <input type="text" autocomplete="off" class="form-control"
                                                       value="{{$offer->value}}"
                                                       placeholder="{{__('productfeaturemodule::admin.amount')}}"
                                                       name="value">
                                            </div>
                                        </div>
                                        ...
                                        <button style="width:100%" class="btn btn-gradient-danger mb-4 mt-3"
                                                type="submit">{{__('productfeaturemodule::admin.update')}}</button>
