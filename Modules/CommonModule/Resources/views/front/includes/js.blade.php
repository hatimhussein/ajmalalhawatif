...
<script src="{{ asset('assets/front/assets/js/autocomplete.js')}}"></script>


<script src="{{ asset('assets/front/assets/js/bootstrap.min.js')}}"></script>
<script src="{{ asset('assets/front/assets/js/parallax.js')}}"></script>
<script src="{{ asset('assets/front/assets/js/common.js')}}"></script>
{{--<script src="{{ asset('assets/front/assets/js/revslider.js')}}"></script>--}}
<script src="{{ asset('assets/front/assets/js/swiper-bundle.min.js')}}"></script>


<script src="{{ asset('assets/front/assets/js/owl.carousel.min.js')}}"></script>
<script src="{{ asset('assets/front/assets/js/jquery.flexslider.js')}}"></script>
<script src="{{ asset('assets/front/assets/js/cloud-zoom.js')}}"></script>
...
<script src="{{ asset('assets/front/assets/js/jquery.ui.touch-punch.min.js')}}"></script>
...
{{--        Swal.fire({--}}
{{--            icon: 'info',--}}
{{--            html: '{{__('warrantymodule::warranty.warranty_replied')}}',--}}
{{--            showCancelButton: true,--}}
{{--            focusConfirm: false,--}}
{{--            confirmButtonColor: '#f9bc16',--}}
{{--            cancelButtonColor: '#0794d4',--}}
{{--            cancelButtonText: '<a style="text-decoration: none;color: #fff;" href="{{route('front.warranty.index')}}">{{__('commonmodule::front.warranty')}}</a>',--}}
{{--            confirmButtonText: '{{__('commonmodule::front.follow_shopping')}}',--}}
