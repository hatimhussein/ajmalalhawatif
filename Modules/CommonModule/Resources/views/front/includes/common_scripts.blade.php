            ...
            'statusCode': {
                200: function (response) {
                    ...
                    if (response.code == 201)
                        ...
                        Swal.fire({
                            icon: 'success',
                            html: '{{__('commonmodule::front.success_cart')}}',
                            showCancelButton: true,
                            focusConfirm: false,
                            confirmButtonColor: '#f9bc16',
                            cancelButtonColor: '#0794d4',
                            cancelButtonText: '<a style="text-decoration: none;color: #fff;" href="{{url('/cart')}}">{{__('commonmodule::front.complete_order')}}</a>',
                            confirmButtonText: '{{__('commonmodule::front.follow_shopping')}}',

                        })
                        {{--                        toastr["success"]('{{__('commonmodule::front.success_cart')}}');--}}
                        $('#cart-sidebar').html('');
                        var total = 0;
                        var elm = '';
                            ...
                            <a href="javascript:void(0);">
                                <p class="notification-head text-center">
                                    <b class="notification-title">
                                        {{__('commonmodule::front.empty_notifications')}}
                            </b>
                        </p>
                    </a>
                </li>`);
