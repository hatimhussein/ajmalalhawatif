...
@section('title')
    {{__('adminmodule::admin.add_new_merchant')}}
@endsection
                ...
                <div class="page-title">
                    ...
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            ...
                            <li><a href="{{url('admin/merchants')}}">{{__('adminmodule::admin.merchants')}}</a></li>
                            <li class="active"><a href="#">{{__('adminmodule::admin.add_new_merchant')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>{{__('adminmodule::admin.add_new_merchant')}}</h4>
                                </div>
                            </div>
                        </div>
                            ...
                            <form action="{{url('admin/merchants')}}" method="POST"
                                ...
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="company_name" value="{{ old('company_name') }}"
                                               ...
                                               placeholder="{{__('adminmodule::admin.company_name')}}" value="Mark"
                                               required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="authorized_person" value="{{ old('authorized_person') }}"
                                               class="form-control" id="validationCustom02"
                                               placeholder="{{__('adminmodule::admin.authorized_person')}}" value="Otto"
                                               required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="commercial_register" value="{{ old('commercial_register') }}"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <select id="phone_code_id" name="phone_code_id" title="Phone Code"
                                            ...
                                            @foreach($phone_codes as $code)
                                                <option
                                                    value="{{$code->id}}" {{ old('phone_code_id') == $code->id ? 'selected' : ($code->status ? 'selected' : '') }}>{!! $code->iso . ' ' . $code->code !!}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" name="phone" value="{{old('phone')}}" minlength="9" maxlength="14"
                                               class="form-control" id="validationCustom03"
                                    ...
                                    <div class="col-lg-2">
                                        <div class="statbox widget box box-shadow">
                                            ...
                                            <label class="switch s-success  mb-4 mr-2">
                                                ...
                                                <input name="has_forward_account" type="checkbox" value="1">
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="account_number" minlength="4" class="form-control"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select id="prices_level" name="prices_level" title="prices_level"
                                            ...
                                            <option value="1">{{__('adminmodule::admin.first_level')}}</option>
                                            <option value="2">{{__('adminmodule::admin.second_level')}}</option>
                                            <option value="3">{{__('adminmodule::admin.third_level')}}</option>
                                            <option value="4">{{__('adminmodule::admin.fourth_level')}}</option>
                                            <option value="5">{{__('adminmodule::admin.fifth_level')}}</option>
                                        </select>
