...
@section('title')
    {{__('areamodule::area.update_country')}}
@endsection
...
@section('content')
  <div id="content" class="main-content">
      <div class="container">
          ...
          <div class="row">
            <form  action="{{url('admin/country/'.$country->id)}}" style="width:100%"  method="POST"  data-role="validator" data-on-before-submit="no_submit" data-on-error-input="notifyOnErrorInput" data-show-error-hint="false" novalidate="novalidate" enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT') }}
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                    <h4>{{__('areamodule::area.update_country')}}</h4>
                                  </div>
                            </div>
                        </div>
                              ...
                              <div class="row">
                                  ...
                                  <label class="col-md-12">{{__('areamodule::area.name_ar')}}</label>
                                        <div class="input-control required col-md-12 mb-4 required">
                                            <input name="name_ar" value="{{$country->name_ar}}" class="form-control" data-validate-func="required" data-validate-arg="6"  data-validate-hint="{{__('areamodule::area.rname_ar')}} " placeholder="{{__('areamodule::area.name_ar')}}" autocomplete="off">
                                        ...
                                        <div class="input-control required col-md-12 mb-4 ">
                                            <input name="name_en" value="{{$country->name_en}}" class="form-control" data-validate-func="required" data-validate-arg="6"  data-validate-hint="{{__('areamodule::area.rname_en')}} " placeholder="{{__('areamodule::area.name_en')}}" autocomplete="off">
                                        ...
                                        <div class="input-control required col-md-12 mb-4 ">
                                            <input type="number" name="code" value="{{$country->code}}" class="form-control" data-validate-func="required" data-validate-arg="6"  data-validate-hint="{{__('areamodule::area.rcode')}} " placeholder="{{__('areamodule::area.code')}}" autocomplete="off">
