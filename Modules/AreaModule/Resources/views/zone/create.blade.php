...
@section('title')
    {{__('areamodule::area.add_new_zone')}}
@endsection
...
@section('content')
  <div id="content" class="main-content">
      <div class="container">
          ...
          <div class="row">
            <form  action="{{url('admin/zone')}}" style="width:100%"  method="POST"  data-role="validator" data-on-before-submit="no_submit" data-on-error-input="notifyOnErrorInput" data-show-error-hint="false" novalidate="novalidate" enctype="multipart/form-data">
              @csrf
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                    <h4>    {{__('areamodule::area.add_new_zone')}}</h4>
                                  </div>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-xl-9 col-lg-9 col-9 ">
                                      ...
                                      <div  class="statbox widget box box-shadow">
                                        ...
                                        <div  class="statbox widget box box-shadow">
                                          <label  >{{__('areamodule::area.city')}}</label>
                                        ...
                                        <label class="col-md-12 pl-0">{{__('areamodule::area.name_en')}}</label>
