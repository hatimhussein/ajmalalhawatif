...
@section('title')
    {{__('areamodule::area.add_new_city')}}
@endsection
...
@section('content')
  <div id="content" class="main-content">
      <div class="container">
          ...
          <div class="row">
            <form  action="{{url('admin/city')}}" style="width:100%"  method="POST"  data-role="validator" data-on-before-submit="no_submit" data-on-error-input="notifyOnErrorInput" data-show-error-hint="false" novalidate="novalidate" enctype="multipart/form-data">
              @csrf
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                    <h4>    {{__('areamodule::area.add_new_city')}}</h4>
                                  </div>
                        ...
                        <div class="widget-content widget-content-area">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6 col-6 ">
                                        ...
                                        <div class="input-control required col-md-12 mb-4 pl-0 required">
                                  ...
                                  <div class="col-md-6 col-6 ">
                                        ...
                                        <div class="input-control required col-md-12 mb-4 pl-0">
                                            <input  name="shipping_price" value="{{ old('shipping_price') }}" class="form-control" data-validate-func="required" data-validate-arg="6"  data-validate-hint="{{__('areamodule::area.rshipping_price')}}" placeholder="{{__('areamodule::area.shipping_price')}}" autocomplete="off">
