...
@section('title')
    {{__('areamodule::area.add_new_government')}}
...
@section('content')
  <div id="content" class="main-content">
      <div class="container">
          ...
          <div class="row">
            <form  action="{{url('admin/government')}}" style="width:100%"  method="POST"  data-role="validator" data-on-before-submit="no_submit" data-on-error-input="notifyOnErrorInput" data-show-error-hint="false" novalidate="novalidate" enctype="multipart/form-data">
              @csrf
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                    <h4>    {{__('areamodule::area.add_new_government')}}</h4>
                                  </div>
