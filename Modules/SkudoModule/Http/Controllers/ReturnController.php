...
class ReturnController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('skudomodule::front.returns.index', compact('returns'));
    }
    ...
    public function myOrders()
    {
        ...
        return view('skudomodule::front.returns.orders', compact('orders'));
    }
    ...
    public function show($id)
    {
        ...
        return view('skudomodule::front.returns.create', compact('products', 'reasons', 'user_addresses'));
    }
