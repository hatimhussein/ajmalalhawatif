...
class ReturnReasonController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('skudomodule::admin.returns.reasons.index', compact('reasons'));
    }
    ...
    {
        return view('skudomodule::admin.returns.reasons.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('skudomodule::admin.returns.reasons.edit', compact('reason'));
    }
