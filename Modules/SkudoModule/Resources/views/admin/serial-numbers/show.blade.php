                                        ...
                                        <div class="widget-content widget-content-area">
                                            <div class="form-row">
                                                <div class="col-md-12 mb-4">
                                                    ...
                                                    <p class="form-control-plaintext">{{ $serialNumber->item_number ?? '-' }}</p>
                                                </div>

                                                <div class="col-md-12 mb-4">
                                                    <label>الباركود:</label>
                                                    <p class="form-control-plaintext">{{ $serialNumber->barcode ?? '-' }}</p>
                                                </div>

                                                <div class="col-md-12 mb-4">
                                                    <label>اسم الصنف (عربي):</label>
                                                    <p class="form-control-plaintext">{{ $serialNumber->product_name_ar ?? '-' }}</p>
                                                </div>

                                                <div class="col-md-12 mb-4">
                                                    <label>اسم الصنف (إنجليزي):</label>
                                                    <p class="form-control-plaintext">{{ $serialNumber->product_name_en ?? '-' }}</p>
                                                </div>

                                                <div class="col-md-12 mb-4">
                                                    <label>الرقم التسلسلي للمنتج:</label>
                                                    <p class="form-control-plaintext">{{ $serialNumber->product_serial ?? '-' }}</p>
                                                </div>

                                                <div class="col-md-12 mb-4">
                                                    <label>تاريخ الإضافة:</label>
                                                    <p class="form-control-plaintext">{{ $serialNumber->formatted_created_at }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
