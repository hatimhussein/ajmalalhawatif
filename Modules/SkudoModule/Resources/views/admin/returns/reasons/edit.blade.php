...
@section('title')
    {{__('warrantymodule::admin.update_reason')}}
@endsection
...
@section('content')
    <div id="content" class="main-content">
        <div class="container">
            ...
            <div class="row">
                <form action="{{ route('reasons.update', $reason->id) }}" class="col-12" method="POST"
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                        <h4>{{__('warrantymodule::admin.update_reason')}}</h4>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="statbox widget box box-shadow ">
                                                    ...
                                                    <div class="widget-content">
                                                        <label class="switch s-success mb-4 mr-2">
                                                            <input name="view_for[]" type="checkbox"
                                                                   value="1" {{ (in_array(1, $reason->view_for)) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-4">
                                                <div class="statbox widget box box-shadow ">
                                                    ...
                                                    <div class="widget-content">
                                                        <label class="switch s-success mb-4 mr-2">
                                                            <input name="view_for[]" type="checkbox"
                                                                   value="0" {{ (in_array(0, $reason->view_for)) ? 'checked' : '' }}>
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </div>
                                                </div>
