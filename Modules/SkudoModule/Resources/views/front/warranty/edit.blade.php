                ...
                <section class="col-md-12">
                    <div class="my-account">
                        ...
                        <form id="warranty-form"
                              action="{{route('front.skudo.warranty.update', $warranty->id)}}" class="form"
                                            ...
                                            @if($inputs->contains('key', 'user_notes'))
                                                <div class="form-group col-md-12">
                                                    <label for="user_notes"
                                                           class="required">{{__('skudomodule::warranty.user_notes')}}
                                                    </label>
                ...
                'statusCode': {
                    200: function (response) {
                        if (response.code === 201) {
                            ...
                            setTimeout(function () {
                                window.location = "{{route('front.skudo.warranty.index', ['type' => $warranty->type])}}";
                            }, 3000);
                        }
                    },
