...
<?php $__env->startSection('content'); ?>
    <div id="content" class="main-content">
        <div class="container">
            ...
            <div class="row">
                <form action="<?php echo e(route('skudo.serial-numbers.store')); ?>" class="col-lg-12" method="POST" data-role="validator"
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-md-6 mb-4 input-control">
                                                                ...
                                                                <input name="product_name_ar" id="product_name_ar" class="form-control" 
                                                                       value="<?php echo e(old('product_name_ar')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-md-6 mb-4 input-control">
                                                                ...
                                                                <input name="product_name_en" id="product_name_en" class="form-control" 
                                                                       value="<?php echo e(old('product_name_en')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-md-12 mb-4 input-control required">
                                                                ...
                                                                <input name="product_serial" id="product_serial" class="form-control" 
                                                                       ...
                                                                       value="<?php echo e(old('product_serial')); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('commonmodule::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\freelancing\أجمل الهواتف\real_web_app\Modules/SkudoModule\Resources/views/admin/serial-numbers/create.blade.php ENDPATH**/ ?>