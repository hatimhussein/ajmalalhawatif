        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"
                    ...
                    <?php echo e(__('warrantymodule::insurance.attachments')); ?>
                    ...
                    if (is_vid(media)) {
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="custom-file-container__image-preview product-list-img" style="border: 2px solid #e0e6ed; border-radius: 8px; padding: 10px; background: #f1f2f3;">
                                <a href="<?php echo e(asset('images/warranty')); ?>/${media}" target="_blank">
                                    <img src="<?php echo e(asset('images/warranty')); ?>/${media}" style="width: 100%; height: auto; border-radius: 4px;" alt="${label}"/>
                                </a>
                            </div>
                        </div>`);
                    }
