<?php if($input->key == 'phone'): ?>
    <div class="row skudo-phone-row" style="display: flex;">
...
<?php else: ?>
    <label for="<?php echo e($input->key); ?>"><?php echo e(__('skudomodule::'.($localeFile ?? 'warranty').'.'.$input->key)); ?>
    ...
    <div class="input-box">
        <input type="<?php echo e($input->properties['type']); ?>" name="<?php echo e($input->key); ?>"
               ...
               title="<?php echo e(__('skudomodule::'.($localeFile ?? 'warranty').'.'.$input->key)); ?>" id="<?php echo e($input->key); ?>"
               class="input-text form-control <?php echo e($input->value_en ? 'required-entry' : ''); ?>"
               value="<?php echo e($value ?? ''); ?>">
    </div>
<?php endif; ?>
<?php /**PATH D:\freelancing\أجمل الهواتف\real_web_app\Modules/SkudoModule\Resources/views/front/includes/input.blade.php ENDPATH**/ ?>