...
<script src="<?php echo e(asset('assets/admin/plugins/scrollbar/jquery.mCustomScrollbar.concat.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('assets/admin/plugins/charts/sparklines/jquery.sparkline.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/plugins/charts/d3charts/d3.v3.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/plugins/charts/c3charts/c3.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/plugins/calendar/pignose/moment.latest.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/plugins/calendar/pignose/pignose.calendar.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/plugins/dropzone/dropzone.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/plugins/progressbar/progressbar.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/js/accounting-dashboard/accounting-custom.js')); ?>"></script>
...
<script>
    $(document).ready(function () {
        ...
        setInterval(function () {
            $.ajax({
                'type': 'get',
                'url': '<?php echo e(url('admin/merchants/getNew')); ?>',
    ...
    function update_status(id, status, token) {
        ...
        $.ajax({
            'type': 'GET',
            'url': '<?php echo e(url("admin/update-tax-status")); ?>',
    ...
    function update_tax_shipping(id, status, token) {
        $.ajax({
            'type': 'GET',
            'url': '<?php echo e(url("admin/update-tax_shipping")); ?>',
            data: {'id': id, 'status': status, '_token': token},
            'statusCode': {
                200: function (response) {
    ...
    function update_tax_product(id, status, token) {
        $.ajax({
            'type': 'GET',
            'url': '<?php echo e(url("admin/update-tax_product")); ?>',
            data: {'id': id, 'status': status, '_token': token},
            'statusCode': {
                200: function (response) {
    ...
    $('.bulk-form [type="submit"]').click(function (e) {
        ...
        let confirmed = true;
        if (method === 'delete') {
            confirmed = confirm("<?php echo e(__('adminmodule::admin.confirm_delete')); ?>");
        }
        if (confirmed) {
...
<?php echo $__env->yieldContent('notification_js'); ?>


<?php echo $__env->yieldContent('js'); ?>

<?php echo $__env->yieldPushContent('js_scripts'); ?>
<?php /**PATH D:\freelancing\أجمل الهواتف\real_web_app\Modules/CommonModule\Resources/views/includes/js.blade.php ENDPATH**/ ?>