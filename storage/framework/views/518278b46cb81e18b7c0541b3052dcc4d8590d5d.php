        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"
                    id="exampleModalLongTitle"><?php echo e(__('warrantymodule::insurance.insurance')); ?></h5>
...
<?php $__env->startPush('js_scripts'); ?>
    <script type="text/javascript">
        function showInsurance(id) {
            const url = '<?php echo route('insurance.show.modal', 'insurance_id'); ?>';
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\freelancing\أجمل الهواتف\real_web_app\Modules/WarrantyModule\Resources/views/admin/includes/insurance_modal.blade.php ENDPATH**/ ?>