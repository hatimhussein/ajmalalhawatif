            ...
            <div class="page-header">
                ...
                <div class="page-title" style="float:right">
                    <a class="mt-4 btn btn-button-16 mr-2"
                       href="<?php echo e(route('insurance.export')); ?>">
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="statbox widget box box-shadow">
                        <div class="widget-header">
                            <form action="<?php echo e(route('insurance.index')); ?>" method="get">
                                <div class="row mt-5">
                            ...
                            <div class="table-responsive mb-4">
                                <table id="zero-config" class="table table-hover table-bordered" style="width:100%">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <th><?php echo e(__('warrantymodule::insurance.company_name')); ?></th>
                                        <th><?php echo e(__('warrantymodule::insurance.company_account')); ?></th>
                                        <th><?php echo e(__('warrantymodule::insurance.user_name')); ?></th>
                                        <th><?php echo e(__('warrantymodule::insurance.phone')); ?></th>
                                        <th><?php echo e(__('warrantymodule::insurance.email')); ?></th>
                                        <th><?php echo e(__('warrantymodule::insurance.dummy_text_1')); ?></th>
                                        <th><?php echo e(__('warrantymodule::insurance.dummy_text_2')); ?></th>
                                        <th><?php echo e(__('warrantymodule::insurance.dummy_text_3')); ?></th>
...
<script src="https://cdn.datatables.net/1.11.3/js/jquery.dataTables.min.js"></script>
    <script>
        let dTable = $('#zero-config').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "sAjaxSource": "<?php echo e(url('admin/insuranceServer?filter='.request()->get('filter').'&date='.request()->get('date'))); ?>",
...
<?php echo $__env->make('commonmodule::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\freelancing\أجمل الهواتف\real_web_app\Modules/WarrantyModule\Resources/views/admin/insurance/index.blade.php ENDPATH**/ ?>