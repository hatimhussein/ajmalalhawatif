                        ...
                        <div class="my-account">
                            ...
                            <?php if($type == 'sms'): ?>
                                <div class="alert alert-success">
                                    <strong><?php echo e(__('skudomodule::warranty.insurance_phone_inquiry')); ?></strong>
                                    <p><?php echo e(__('skudomodule::warranty.enter_insurance_phone')); ?></p>
                                    <small class="text-muted"><?php echo e(__('skudomodule::warranty.insurance_phone_help')); ?></small>
                                </div>
                            <?php endif; ?>
                                                ...
                                                <div class="col-md-6">
                                                    <?php if($inputs->contains('key', 'warranty_number')): ?>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="warranty_number"><?php echo e(__('skudomodule::warranty.phone')); ?>

                                                                <?php if($warrantyInput->value_en): ?><em class="required">*</em><?php endif; ?>
                                                            </label>
                                                            <div class="input-box">
                                                                <div class="input-group" id="warranty_number_group" style="direction: rtl;">
                                                                    <input type="text" name="phone_search" id="warranty_number" 
                                                                        title="<?php echo e(__('skudomodule::warranty.phone')); ?>"
                                                                        class="input-text form-control <?php echo e($warrantyInput->value_en ? 'required-entry' : ''); ?>" 
                                                                        placeholder="<?php echo e(__('skudomodule::warranty.insurance_phone_placeholder')); ?>"
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <button type="button" id="search_warranty_btn" class="btn btn-primary" 
                                                                            ...
                                                                            <?php echo e(__('skudomodule::warranty.insurance_phone_search_button')); ?>

                                                                        </button>
                                                                    </div>
                                                                </div>
                                                                <input type="hidden" name="warranty_number" id="selected_warranty_number" value="">
                                                                <small class="form-text text-muted" style="font-size: 11px; font-weight: bold; color: black;"><?php echo e(__('skudomodule::warranty.insurance_phone_help')); ?></small>
                                                            </div>
                                                        </div>
                                                    <?php endif; ?>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="insuranceSelectModalTitle"><?php echo e(__('skudomodule::warranty.select_insurance_modal_title')); ?></h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <p class="text-muted mb-3"><?php echo e(__('skudomodule::warranty.select_insurance_modal_hint')); ?></p>
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover">
                                                    <thead>
                                                    <tr>
                                                        <th><?php echo e(__('skudomodule::warranty.select_insurance_table_id')); ?></th>
        ...
        <?php if($type == 'sms'): ?>
            <script type="text/javascript">
                ...
                $('#search_warranty_btn').on('click', function() {
                    ...
                    if (!phone) {
                        toastr["warning"]("<?php echo e(__('skudomodule::warranty.enter_phone_first')); ?>");
                        return;
                    }
                ...
                function performSearch(phone) {
                    ...
                    $('#search_warranty_btn').prop('disabled', true).html('<i class="fa fa-spinner fa-spin"></i> <?php echo e(__('skudomodule::warranty.insurance_phone_loading')); ?>');
                    ...
                    $.get(phoneUrl, { phone })
                        .done(response => {
                            ...
                            if (!insurances.length) {
                                fillInsuranceInputs();
                                $('#selected_warranty_number').val('');
                                toastr["error"]("<?php echo e(__('skudomodule::warranty.no_insurance_found_for_phone', ['phone' => ':phone'])); ?>".replace(':phone', phone));
                                return;
                            }
                        ...
                        .fail(response => {
                            fillInsuranceInputs();
                            hideLoader();
                            toastr["error"]("<?php echo e(__('skudomodule::warranty.insurance_fetch_error')); ?>");
                        })
                        .always(() => {
                            isLoading = false;
                            // إعادة تفعيل الزر
                            $('#search_warranty_btn').prop('disabled', false).html('<?php echo e(__('skudomodule::warranty.insurance_phone_search_button')); ?>');
                        });
                }
                ...
                function showLoader() {
                    ...
                    if ($('#warranty-loader').length === 0) {
                        $('body').append('<div id="warranty-loader" class="warranty-loader-overlay"><div class="warranty-loader-content"><div class="warranty-spinner"></div><p><?php echo e(__('skudomodule::warranty.insurance_phone_loading')); ?></p></div></div>');
                    }
