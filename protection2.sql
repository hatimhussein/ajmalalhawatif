...
--
-- Host: localhost
-- Generation Time: Feb 24, 2022 at 03:39 PM
...
(3, 284, 6185, NULL, 2, 0, 'value', '2021-09-29 17:48:37', NULL, 1, '2021-09-29 16:48:37', '2022-02-13 16:30:43', '2022-02-13 18:30:43'),
(4, 284, 5293, NULL, 1, 0, 'value', '2021-09-29 17:48:39', NULL, 1, '2021-09-29 16:48:39', '2022-02-13 16:30:43', '2022-02-13 18:30:43'),
(5, 284, 5294, NULL, 1, 0, 'value', '2021-12-19 15:57:34', NULL, 1, '2021-12-19 14:57:34', '2022-02-13 16:30:43', '2022-02-13 18:30:43');
...
(282, 'Osama', 'Elzero', 'mazen@pioneers-solutions.com', '1159411123', 57, NULL, NULL, NULL, '$2y$10$NuF8VtkBUXXvLNGYMn7AoeO37o2h/Ck6vtJRsI1ZXYiYvd.YqlMra', 1, 56, 47, 11, 'skdyLVIS81SCRO42X5Vd8iqYiDczPBZYHI2uq3W3AJVo8RLjiaQtLk4aAV5A', '2021-08-10 12:21:23', '2021-09-29 16:41:49', 0, NULL, 1, 0, NULL, 0, NULL, NULL, NULL, 5, 0, NULL, NULL, NULL, 1, NULL),
...
(195, 282, 0, 1, '2021-09-27', '2021-09-27 15:49:20'),
(196, 242, 1, 2, '2021-09-28', '2021-09-28 20:04:29'),
(197, 282, 0, 1, '2021-09-29', '2021-09-29 08:23:48'),
...
--
ALTER TABLE `order_products`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1852;
...
ALTER TABLE `warranties`
  ...
  ADD CONSTRAINT `warranties_insurance_id_foreign` FOREIGN KEY (`insurance_id`) REFERENCES `insurances` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `warranties_phone_code_id_foreign` FOREIGN KEY (`phone_code_id`) REFERENCES `phone_codes` (`id`) ON DELETE SET NULL,
